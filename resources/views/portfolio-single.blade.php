...
<body>
    ...
    <nav class="navbar navbar-expand-lg  bg-dark">
      <div class="container-fluid">
        ...
        <ul class="navbar-nav pl-md-5 ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="portfolio">Websites</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="portfolio2">APPS</a>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link" href="services">Services</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="portfolio-single">All Projects</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
      <div class="row slider-text align-items-center justify-content-center text-center">
        <div class="col-lg-12 col-sm-12">
          <h1 class="mb-4" data-aos="fade-up" data-aos-delay="">Project Single Page</h1>
          <p class="custom-breadcrumbs" data-aos="fade-up" data-aos-delay="100"><a href="index.html">Home</a> <span class="mx-3">/</span> Projects Single Page</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="section">
    <div class="container">
      <div class="row mb-5">
        <div class="col-lg-7">
          <a href="images/work_1.jpg" class="mb-3 d-block" data-fancybox="gal"><img src="images/work_1.jpg" alt="Image" class="img-fluid"></a>
          <a href="images/work_2.jpg" class="mb-3 d-block" data-fancybox="gal"><img src="images/work_2.jpg" alt="Image" class="img-fluid"></a>
          <a href="images/work_4.jpg" class="d-block" data-fancybox="gal"><img src="images/work_4.jpg" alt="Image" class="img-fluid"></a>
        </div>
