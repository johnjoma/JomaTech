...
<head>
  <title>JomaTech &mdash; moving technologies</title>
  <meta charset="utf-8">
  ...
  <header role="banner">
    <nav class="navbar navbar-expand-lg  bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand " href="index">JomaTech</a>
    ...
    <div class="container">
      <div class="row mb-5 no-gutters">
        <div class="col-sm-6 col-md-6 col-lg-6" data-aos="fade" data-aos-delay="100">
          <a href="portfolio-single" class="work-thumb">
            <div class="work-text">
  ...
  <div class="section bg-light block-11">
    <div class="container">
      <div class="row justify-content-center mb-5">
        <div class="col-md-8 text-center">
          <h2 class="mb-4 section-title">Coming Soon</h2>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 ml-auto pl-lg-4 mb-5 order-2">
          ...
          <img src="images/feature2.jpg" alt="Image" class="img-fluid mb-5">
          ...
          <p><a href="about" class="btn btn-outline-black">Learn More</a></p>
        </div>
        <div class="col-lg-6 order-1">
          <figure class="img-dotted-bg">
            <img src="images/feature1.jpg" alt="Image" class="img-fluid">
          </figure>
    ...
    <div class="container text-center">
      <div class="row justify-content-center">
        <div class="col-lg-7">
          ...
          <p class="mb-0" data-aos="fade-up" data-aos-delay="200"><a href="contact" class="btn btn-outline-white px-4 py-3">Get In Touch!</a></p>
        </div>
      </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-md-3 ml-auto">
          ...
          <ul class="list-unstyled footer-link">
            ...
            <li><a href="portfolio-single">All Projects</a></li>
